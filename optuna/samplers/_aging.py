...
_CONSTRAINTS_KEY = "aging:constraints"
_PARENTS_KEY = "aging:parents"


class AgingEvolutionSampler(BaseSampler):
    """Single-objective sampler based on Aging Evolution.

    Aging evolution is a simple non-elitist genetic algorithm, which simply removes the oldest
    individual from population instead of the worst one.

    For more information about Aging Evolution, please refer to the following paper:

    - `Regularized Evolution for Image Classifier Architecture Search
    <https://arxiv.org/abs/1802.01548>`_
...
def _constrained_dominates(
    ...
    if constraints0 is None and constraints1 is None:
        ...
        return _dominates(trial0, trial1, direction)
